...
My [MongoDB Cluster](/readme/img/mongodb/mongodb_cluster.png) is titled pigGinnel, and is composed of the database ginnelPig. Within that, there are two collections. 
...
- In the settings, you will need to set the follow [Config Vars](/readme/img/features/heroku_config.png)
